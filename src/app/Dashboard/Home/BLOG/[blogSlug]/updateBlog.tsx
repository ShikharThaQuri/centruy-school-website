...
export default function UpdateSingleBlog({
  Title,
  BlogDis,
  BlogId,
  WritterName,
  ...
  const [data, action, isPending] = useActionState(updateBlog, undefined);
  ...
  useEffect(() => {
    ...
    if (data?.success === true) {
      router.push("/Dashboard/Home/BLOG");
    }
  }, [data, router]);
    ...
    <div className="py-[2rem] flex items-center justify-center h-screen bg-gray-100">
      <div className="bg-white p-8 rounded shadow-md w-96">
        ...
        <form action={action} className="flex flex-col">
          <input type="text" hidden defaultValue={BlogId} name="id" />
